...
{
    /// <summary>
    /// Utilities useful for converting from Bouncy Castle class instances to MS encryption class instances.
    /// </summary>
    public class DotNetUtilities // Implementation taken from https://github.com/bcgit/bc-csharp/blob/master/crypto/src/security/DotNetUtilities.cs
    {
